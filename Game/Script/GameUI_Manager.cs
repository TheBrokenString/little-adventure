...
public class GameUI_Manager : MonoBehaviour
{
    ...
    void Update()
    {
        healthSlider.value = GM.playerCharacter.GetComponent<Health>().CurrentHealthPercentage;//治疗关联UI slider
        CoinText.text = GM.playerCharacter.Coin.ToString();//金币关联UI
        HP_text.text = GM.playerCharacter.GetComponent<Health>().CurrentHealth+"/"+ GM.playerCharacter.GetComponent<Health>().MaxHealth;
